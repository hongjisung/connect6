...
public class Main extends JFrame implements Runnable, KeyListener {
    ...
    private int[][][][] info = new int[2][361][20][20]; // 2*361*20*20 각 턴에서 who 마다 i칸(빈칸+who칸)중 who돌 j개   who 1->0 2->1
    ...
    public int check(int who, int yPos, int xPos){ // 0이면 아직 안끝 이긴사람 번호 return 1 or 2
